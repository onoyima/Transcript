        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-gray-600 mt-1">Reference: {{ $application->ref_no ?? 'N/A' }}</p>
                </div>
                <div class="flex space-x-3">
                    ...
                    <a href="{{ route('student.transcript.history') }}" class="inline-flex items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-900 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                ...
                <dl class="space-y-3">
                    <div>
                        ...
                        <dd class="text-sm text-gray-900">{{ ucfirst($application->application_type) }}</dd>
                    </div>
                    <div>
                        <dt class="text-sm font-medium text-gray-600">Category</dt>
                        <dd class="text-sm text-gray-900">{{ ucfirst($application->category) }}</dd>
                    </div>
                    <div>
                        <dt class="text-sm font-medium text-gray-600">Type</dt>
                        <dd class="text-sm text-gray-900">{{ ucfirst($application->type) }}</dd>
                    </div>
                    <div>
                        <dt class="text-sm font-medium text-gray-600">Number of Copies</dt>
                        <dd class="text-sm text-gray-900">{{ $application->number_of_copies }}</dd>
                    </div>
                    <div>
                        <dt class="text-sm font-medium text-gray-600">Purpose</dt>
                        <dd class="text-sm text-gray-900">{{ $application->purpose ?? 'N/A' }}</dd>
                    </div>
                    <div>
                        <dt class="text-sm font-medium text-gray-600">Total Amount</dt>
                        <dd class="text-sm text-gray-900 font-semibold">₦{{ number_format($application->total_amount, 2) }}</dd>
                    </div>
                </dl>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                ...
                <dl class="space-y-3">
                    <div>
                        ...
                        <dd class="text-sm text-gray-900">{{ ucfirst($application->destination) }}</dd>
                    </div>
                    <div>
                        <dt class="text-sm font-medium text-gray-600">Institution Name</dt>
                        <dd class="text-sm text-gray-900">{{ $application->institution_name ?? 'N/A' }}</dd>
                    </div>
                    <div>
                        <dt class="text-sm font-medium text-gray-600">Institution Phone</dt>
                        <dd class="text-sm text-gray-900">{{ $application->institutional_phone ?? 'N/A' }}</dd>
                    </div>
                    <div>
                        <dt class="text-sm font-medium text-gray-600">Institution Email</dt>
                        <dd class="text-sm text-gray-900">{{ $application->institutional_email ?? 'N/A' }}</dd>
                    </div>
                    <div>
                        <dt class="text-sm font-medium text-gray-600">Courier</dt>
                        <dd class="text-sm text-gray-900">{{ ucfirst($application->courier) }}</dd>
                    </div>
                    <div>
                        <dt class="text-sm font-medium text-gray-600">Delivery Address</dt>
                        <dd class="text-sm text-gray-900">{{ $application->delivery_address ?? 'N/A' }}</dd>
                    </div>
                </dl>
            </div>
        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <dl class="space-y-3">
                    <div>
                        ...
                        <dd class="text-sm text-gray-900">{{ $application->created_at->format('M d, Y') }}</dd>
                    </div>
                    <div>
                        <dt class="text-sm font-medium text-gray-600">Last Updated</dt>
                        <dd class="text-sm text-gray-900">{{ $application->updated_at->format('M d, Y') }}</dd>
                    </div>
                </dl>
            </div>
        </div>
