...
<div class="min-h-screen bg-white dark:bg-gray-900 py-8">
    ...
    <p class="text-gray-900 dark:text-gray-100 mt-1">Submit a new transcript request</p>
                ...
                <a href="{{ route('student.dashboard') }}" class="inline-flex items-center px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm text-sm font-medium text-black dark:text-gray-100 bg-white dark:bg-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">
            ...
            <div class="p-6">
                <form id="transcriptForm" action="{{ route('student.transcript.store') }}" method="POST">
                    ...
                    <div class="mb-6" id="selfEcopySection" style="display: none;">
                        ...
                        <input type="email" id="self_email" name="self_email" value="{{ $student->email ?? '' }}" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-green-500 focus:border-green-500 dark:bg-gray-700 dark:text-white" readonly>
                    ...
                    <div class="mb-6" id="emailConfirmationSection" style="display: none;">
                        ...
                        <input type="email" id="student_email" name="student_email" value="{{ $student->email ?? '' }}" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-green-500 focus:border-green-500 dark:bg-gray-700 dark:text-white" readonly>
                    ...
                    <div class="flex gap-4 pt-6 border-t border-gray-200 dark:border-gray-700">
                        <a href="{{ route('student.dashboard') }}" class="px-6 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm text-sm font-medium text-black dark:text-gray-100 bg-white dark:bg-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">
                            Cancel
                        </a>
