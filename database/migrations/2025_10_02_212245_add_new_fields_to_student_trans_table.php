...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('student_trans', function (Blueprint $table) {
            $table->enum('category', ['self', 'institutional'])->nullable()->after('application_status');
            $table->enum('type', ['physical', 'ecopy'])->nullable()->after('category');
            $table->enum('destination', ['self', 'local', 'international', 'institutional'])->nullable()->after('type');
