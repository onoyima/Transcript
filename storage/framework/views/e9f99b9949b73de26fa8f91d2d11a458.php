        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200/50 dark:border-gray-700/50">
            <div class="p-6">
                <form id="transcriptForm" action="<?php echo e(route('student.transcript.store')); ?>" method="POST">
                    ...
                    <div class="mb-6">
                        <label for="application_type" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-3">
                        ...
                        <select id="categorySelect" name="application_type" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-700 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 bg-white dark:bg-gray-800 text-gray-900 dark:text-white" required>
                    ...
                    <div class="mb-6" id="requestTypeSection" style="display: none;">
                        <label for="request_type" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-3">
                        ...
                        <select id="requestTypeSelect" name="request_type" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-700 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 bg-white dark:bg-gray-800 text-gray-900 dark:text-white" required>
                            <option value="">Select one</option>
                    ...
                    <div class="mb-6" id="deliveryOptionsSection" style="display: none;">
                                    ...
                                    <label for="physical_self" class="flex items-center p-4 border-2 border-gray-200 dark:border-gray-600 rounded-lg cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-700 peer-checked:border-green-500 peer-checked:bg-green-50 dark:peer-checked:bg-green-900/20">
                                        <div class="flex items-center">
                                            ...
                                            <div>
                                                ...
                                                <div class="text-sm text-gray-600 dark:text-gray-300">Pick up from university</div>
                                            </div>
                                        </div>
                                    </label>
                                </div>
                                    ...
                                    <label for="ecopy_self" class="flex items-center p-4 border-2 border-gray-200 dark:border-gray-600 rounded-lg cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-700 peer-checked:border-green-500 peer-checked:bg-green-50 dark:peer-checked:bg-green-900/20">
                                        <div class="flex items-center">
                                            ...
                                            <div>
                                                ...
                                                <div class="text-sm text-gray-600 dark:text-gray-300">Electronic delivery via email</div>
                                            </div>
                                        </div>
                                    </label>
                                </div>
                                ...
                                <div class="relative">
                                    ...
                                    <label for="physical_institutional" class="flex items-center p-4 border-2 border-gray-200 dark:border-gray-600 rounded-lg cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-700 peer-checked:border-green-500 peer-checked:bg-green-50 dark:peer-checked:bg-green-900/20">
                                        <div class="flex items-center">
                                            ...
                                            <div>
                                                <div class="font-medium text-gray-900 dark:text-white">Physical Institutional</div>
                                                <div class="text-sm text-gray-600 dark:text-gray-300">Courier delivery to institution</div>
                                            </div>
                                        </div>
                                    </label>
                                </div>
                                    ...
                                    <label for="ecopy_institutional" class="flex items-center p-4 border-2 border-gray-200 dark:border-gray-600 rounded-lg cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-700 peer-checked:border-green-500 peer-checked:bg-green-50 dark:peer-checked:bg-green-900/20">
                                        <div class="flex items-center">
                                            ...
                                            <div>
                                                ...
                                                <div class="text-sm text-gray-600 dark:text-gray-300">Electronic delivery to institution</div>
                                            </div>
                                        </div>
                                    </label>
                                </div>
                        ...
                        <div id="institutionalPhysicalSubOptions" style="display: none;" class="mt-4">
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-3">Choose Delivery Location</label>
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div class="relative">
                                    ...
                                    <label for="local_institutional" class="flex items-center p-4 border-2 border-gray-200 dark:border-gray-600 rounded-lg cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-700 peer-checked:border-green-500 peer-checked:bg-green-50 dark:peer-checked:bg-green-900/20">
                                        <div class="flex items-center">
                                            ...
                                            <div>
                                                <div class="font-medium text-gray-900 dark:text-white">Local Institutional</div>
                                                <div class="text-sm text-gray-600 dark:text-gray-300">Within Nigeria</div>
                                            </div>
                                        </div>
                                    </label>
                                </div>
                                <div class="relative">
                                    ...
                                    <label for="international_institutional" class="flex items-center p-4 border-2 border-gray-200 dark:border-gray-600 rounded-lg cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-700 peer-checked:border-green-500 peer-checked:bg-green-50 dark:peer-checked:bg-green-900/20">
                                        <div class="flex items-center">
                                            ...
                                            <div>
                                                <div class="font-medium text-gray-900 dark:text-white">International Institutional</div>
                                                <div class="text-sm text-gray-600 dark:text-gray-300">Outside Nigeria</div>
                                            </div>
                                        </div>
                                    </label>
                                </div>
                    ...
                    <div class="mb-6" id="courierSelectionSection" style="display: none;">
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-3">Select Courier Service</label>
                        <div class="space-y-3">
                            <div class="flex items-center p-4 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 cursor-pointer">
                                ...
                                <label for="dhl_courier" class="ml-3 cursor-pointer flex-1">
                                    ...
                                    <div class="text-sm text-gray-600 dark:text-gray-300 courier-price" data-courier="dhl">₦3,000</div>
                                </label>
                            </div>
                            <div class="flex items-center p-4 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 cursor-pointer">
                                ...
                                <label for="zcarex_courier" class="ml-3 cursor-pointer flex-1">
                                    ...
                                    <div class="text-sm text-gray-600 dark:text-gray-300 courier-price" data-courier="zcarex">₦30,000</div>
                                </label>
                            </div>
                            <div class="flex items-center p-4 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 cursor-pointer">
                                ...
                                <label for="couples_courier" class="ml-3 cursor-pointer flex-1">
                                    ...
                                    <div class="text-sm text-gray-600 dark:text-gray-300 courier-price" data-courier="couples">₦3,000</div>
                                </label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-6" id="institutionalPhysicalDetailsSection" style="display: none;">
                        <div class="space-y-4">
                            <div>
                                ...
                                <input type="text" id="institution_name" name="institution_name" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-700 rounded-md shadow-sm focus:outline-none focus:ring-green-500 focus:border-green-500 bg-white dark:bg-gray-800 text-gray-900 dark:text-white" placeholder="Enter institution name">
                            </div>
                            <div>
                                <label for="institutional_email" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Institution Registrar Email</label>
                                <input type="email" id="institutional_email" name="institution_email" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-700 rounded-md shadow-sm focus:outline-none focus:ring-green-500 focus:border-green-500 bg-white dark:bg-gray-800 text-gray-900 dark:text-white" placeholder="Enter institutional email">
                            </div>
                            <div>
                                <label for="delivery_address" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Delivery Address</label>
                                <textarea id="delivery_address" name="delivery_address" rows="3" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-700 rounded-md shadow-sm focus:outline-none focus:ring-green-500 focus:border-green-500 bg-white dark:bg-gray-800 text-gray-900 dark:text-white" placeholder="Enter delivery address"></textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-6" id="institutionalEcopyDetailsSection" style="display: none;">
                        <div class="space-y-4">
                            <div>
                                <label for="institution_name_ecopy" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Institution Name</label>
                                <input type="text" id="institution_name_ecopy" name="institution_name" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-700 rounded-md shadow-sm focus:outline-none focus:ring-green-500 focus:border-green-500 bg-white dark:bg-gray-800 text-gray-900 dark:text-white" placeholder="Enter institution name">
                            </div>
                            <div>
                                <label for="institutional_email_ecopy" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Institution Registrar Email</label>
                                <input type="email" id="institutional_email_ecopy" name="institution_email" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-700 rounded-md shadow-sm focus:outline-none focus:ring-green-500 focus:border-green-500 bg-white dark:bg-gray-800 text-gray-900 dark:text-white" placeholder="Enter institutional email">
                            </div>
                            <div>
                                <label for="institution_address_ecopy" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Institution Address</label>
                                <textarea id="institution_address_ecopy" name="delivery_address" rows="3" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-700 rounded-md shadow-sm focus:outline-none focus:ring-green-500 focus:border-green-500 bg-white dark:bg-gray-800 text-gray-900 dark:text-white" placeholder="Enter institution address"></textarea>
                            </div>
                        </div>
                        <div class="mt-4 p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg">
                            <div class="flex items-center justify-between">
                                <div>
                                    <div class="font-medium text-gray-900 dark:text-white">E-Copy Institutional</div>
                                    <div class="text-sm text-gray-600 dark:text-gray-300">Electronic transcript to institution</div>
                                </div>
                    ...
                    <div class="mb-6" id="institutionDetailsSection" style="display: none;">
                        ...
                        <div class="mb-4">
                            <label for="ref_no" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Reference Number <span class="text-gray-500">(Optional)</span></label>
                            <input type="text" id="ref_no" name="ref_no" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-700 rounded-md shadow-sm focus:outline-none focus:ring-green-500 focus:border-green-500 bg-white dark:bg-gray-800 text-gray-900 dark:text-white" placeholder="Enter reference number">
                        </div>
                        <div class="mb-4">
                            <label for="institutional_email" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Institution Registrar Email</label>
                            <input type="email" id="institutional_email" name="institution_email" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-700 rounded-md shadow-sm focus:outline-none focus:ring-green-500 focus:border-green-500 bg-white dark:bg-gray-800 text-gray-900 dark:text-white" placeholder="Enter institutional email">
                        ...
                        <div class="mb-4" id="institutionalPhoneSection" style="display: none;">
                            <label for="institutional_phone" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Institution Phone Number</label>
                            <input type="tel" id="institutional_phone" name="institutional_phone" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-700 rounded-md shadow-sm focus:outline-none focus:ring-green-500 focus:border-green-500 bg-white dark:bg-gray-800 text-gray-900 dark:text-white" placeholder="Enter phone number">
                        </div>
                    </div>
                    ...
                    <div class="mb-6" id="deliveryAddressSection" style="display: none;">
                        <label for="delivery_address" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Delivery Address</label>
                        <textarea id="delivery_address" name="delivery_address" rows="3" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-700 rounded-md shadow-sm focus:outline-none focus:ring-green-500 focus:border-green-500 bg-white dark:bg-gray-800 text-gray-900 dark:text-white" placeholder="Enter complete delivery address (Google Maps or OpenStreetMap compatible)"></textarea>
                    ...
                    <div class="mb-6" id="purposeSection" style="display: none;">
                        <label for="purpose" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Purpose of Request</label>
                        <textarea id="purpose" name="purpose" rows="3" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-700 rounded-md shadow-sm focus:outline-none focus:ring-green-500 focus:border-green-500 bg-white dark:bg-gray-800 text-gray-900 dark:text-white" placeholder="Please specify the purpose for this transcript request..."></textarea>
                    </div>
                    ...
                    <div class="mb-6" id="priceSummarySection" style="display: none;">
                        <div class="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-4">
                            <div class="font-medium text-gray-900 dark:text-white">Total Amount</div>
                            <div class="text-sm text-gray-600 dark:text-gray-300" id="totalBreakdown">Base fee + delivery charges</div>
                        ...
                        <div class="space-y-3">
                            <div class="flex items-center p-4 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 cursor-pointer">
                                ...
                                <label for="paystack" class="ml-3 cursor-pointer flex-1">
                                    <div class="flex items-center justify-between">
                                        <div>
                                            <div class="font-medium text-gray-900 dark:text-white">Paystack</div>
                                            <div class="text-sm text-gray-600 dark:text-gray-300">Pay with Cards, Bank Transfer, USSD</div>
                                        </div>
                            ...
                            <div class="flex items-center p-4 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 cursor-pointer">
                                ...
                                <label for="remita" class="ml-3 cursor-pointer flex-1">
                                    <div class="flex items-center justify-between">
                                        <div>
                                            <div class="font-medium text-gray-900 dark:text-white">Remita</div>
                                            <div class="text-sm text-gray-600 dark:text-gray-300">Pay with Bank Transfer, Cards</div>
                                        </div>
