<!DOCTYPE html>
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>" x-data="themeData()" x-init="init()" :class="{ 'dark': darkMode }">
...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Staff Portal'); ?> - <?php echo e(config('app.name', 'Transcript System')); ?></title>
...
<body class="bg-gray-50 dark:bg-gray-900 font-sans antialiased" x-data="{ sidebarToggle: false }">
    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <!-- Sidebar -->
        <?php echo $__env->make('spartials.staff-sidebar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        ...
        <div class="flex-1 flex items-center justify-center">
            <div class="text-center">
                ...
                <a href="<?php echo e(route('transcript.staff.login')); ?>" class="inline-flex items-center px-4 py-2 bg-primary-600 hover:bg-primary-700 text-white font-medium rounded-lg transition-colors duration-200">
...
</html><?php /**PATH C:\Users\Veritas ICT\Downloads\trans\transcript-system\resources\views/layouts/staff.blade.php ENDPATH**/ ?>