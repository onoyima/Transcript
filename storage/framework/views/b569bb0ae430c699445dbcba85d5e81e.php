<aside :class="sidebarToggle ? 'translate-x-0 lg:w-[90px] lg:px-2' : '-translate-x-full lg:px-5'"
    class="sidebar fixed top-0 left-0 z-50 flex h-screen w-[290px] flex-col border-r border-gray-200/50 bg-white/95 backdrop-blur-xl px-3 transition-all duration-300 lg:static lg:translate-x-0 dark:border-gray-700/50 dark:bg-gray-900/95 shadow-xl"
