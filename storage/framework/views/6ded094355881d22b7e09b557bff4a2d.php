...
<body>
    <div class="email-container">
        ...
        <div class="steps">
            ...
            <div class="step">Click the "Reset Your Password" button above to set your own password (recommended)</div>
            <div class="step">Alternatively, login using the temporary password above</div>
            <div class="step">If you login with the temporary password, you will be required to change it immediately</div>
            <div class="step">After changing your password, continue your transcript application</div>
        </div>
